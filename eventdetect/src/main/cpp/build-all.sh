...
g++ -o bin/ed ed.cpp -ggdb -std=c++11 `pkg-config --cflags --libs /home/mosaiq/src/java/javacpp-presets/opencv/cppbuild/linux-x86_64/opencv-3.1.0/unix-install/opencv.pc`  -L./  -led
